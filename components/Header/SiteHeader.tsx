      ...
      <nav className={(open ? "sm:items-center sm:px-4" : "hidden sm:block justify-between")}>
        <div className="xl:grid sm:items-center sm:px-4 xl:grid-cols-2 2xl:grid-cols-4 xl:w-full">
          ...
          <div className="ml-4 xl:col-start-3 2xl:col-start-5 sm:flex sm:items-center">
            ...
            <div className='px-5 py-4 sm:py-0 sm:ml-4 sm:px-0'>
              <div className='flex items-center'>
                <img className='object-cover w-10 h-10 mt-1 rounded-full sm:h-8 sm:w-8 ring-2 ring-gray-600' src="https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=260&q=80" alt="" />
                <span className='ml-4 font-semibold text-gray-200 sm:hidden'>Isla Schoger</span>
              </div>
              <div className='mt-4 sm:hidden'>
                <a href="#" className='block py-1 text-gray-400 hover:text-white'>Account Settings</a>
                <a href="#" className='block py-1 mt-1 text-gray-400 hover:text-white'>Support</a>
                <a href="#" className='block py-1 mt-1 text-gray-400 hover:text-white'>Sign Out</a>
              </div>
            </div>
          </div>
        </div>
